...
curl https://raw.githubusercontent.com/ipython/docker-notebook/master/scipystack/numpy-site.cfg -o /tmp/numpy-site.cfg
curl https://raw.githubusercontent.com/ipython/docker-notebook/master/scipystack/scipy-site.cfg -o /tmp/scipy-site.cfg
